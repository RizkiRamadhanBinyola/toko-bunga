...
<head>
    ...
    <title>Sesi Kedaluwarsa — {{ $storeName }}</title>
    @if($favicon)
...
<body class="font-sans antialiased bg-white text-gray-800 min-h-screen flex items-center justify-center">
    <div class="text-center px-4">
        <div class="text-8xl font-bold text-rose-200 mb-4">419</div>
        <h1 class="text-2xl font-semibold text-gray-900 mb-2">Sesi Kedaluwarsa</h1>
